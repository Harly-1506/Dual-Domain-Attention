...
class CANet(ResNet):
    def __init__(self):
        ...
        # try 3 and 6 resblock : trying
        #try another network 5,10, 4,8 3,6 2,4
        # try 3,6, RIR with output conv2d bias False
        self.Myblock1 = Network(64,3,6,2) # 2-4
        self.Myblock2 = Network(128,3,6,2) # 3 -6
        self.Myblock3 = Network(256,3,6,2) # 4- 8
        self.Myblock4 = Networklast(512,3,6) # 4 - 8
...
def CAModel_dropout1(in_channels=3, num_classes=7):
    model = CANet()
